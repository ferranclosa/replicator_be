...
public class LoadProps {
    ...
    public ConnectionParams loadProps(String code) throws ItemNotFoundException {
        ...
        if (oRq.isPresent()) {
            ...
            return cp;
        } else throw new ItemNotFoundException("Request Code Not found. Unable to establish a Connection");
    }
